...
\t\033[00m IM CRACKER MEDAN-XPLOIT
\t\033[90m -----------------------\033[94m\n
===========================================\033[00m
Author Script \033[1;91m: \033[1;96m./Mando-Xploit\033[00m
Facebook Me   \033[1;91m: \033[1;96mSu Mando\033[00m
Github  \033[1;91m: \033[4;92mgithub.com/MRKALIT09\033[00m
\033[94m===========================================\033[00m""")
def balik():
...
def mbf():
    ...
    print("\033[00m[\033[93m3\033[00m] Group WhatsApp")
    print("\033[00m[\033[93m4\033[00m] Log Out Script")
    time.sleep(0.1)
    f=input("\n\033[90m> \033[1;93m")
    if f == "1":
         ...
         os.system("xdg-open https://chat.whatsapp.com/KZLrpmCkKc53eSVDZW9vnb")
         balik()
